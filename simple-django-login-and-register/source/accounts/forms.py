...
class VendorForm(forms.Form):
    shop = forms.CharField(label="shop name", max_length=25)
    shop_phone = forms.CharField(label="shop phone number", max_length=15)
    phone = forms.CharField(label="your Mobile number", max_length=15)
