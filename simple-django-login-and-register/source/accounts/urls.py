...
from .views import (
    LogInView, BecomeVendorView, RegisterVendorView, ResendActivationCodeView, RemindUsernameView, SignUpView, ActivateView, LogOutView,
...
urlpatterns = [
    ...
    path('vendor/', RegisterVendorView.as_view(), name='register_vendor'),
