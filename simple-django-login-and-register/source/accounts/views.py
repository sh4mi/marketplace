...
from .forms import (
    SignInViaUsernameForm, SignInViaEmailForm, SignInViaEmailOrUsernameForm, SignUpForm, VendorForm,
    RestorePasswordForm, RestorePasswordViaEmailOrUsernameForm, RemindUsernameForm,
    ResendActivationCodeForm, ResendActivationCodeViaEmailForm, ChangeProfileForm, ChangeEmailForm,
)
from .models import Activation, Vendor, Address
...
class BecomeVendorView(TemplateView):
    template_name = 'accounts/become_vendor.html'


class RegisterVendorView(LoginRequiredMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        if check_vendor:
            ...
            shop = Shop()
            shop.vendor = vendor
            shop.name = form.cleaned_data['shop']
            shop.phone =form.cleaned_data['shop_phone']
            shop.phone2 =form.cleaned_data['phone']
            shop.address = address.address = form.cleaned_data['address']
            shop.save()
...
def check_vendor_on_login(sender, request, user, **kwargs):
    """
...
def check_vendor_on_logout(sender, request, user, **kwargs):
    """
    A signal receiver which performs some actions for
    the user logging in.
    """
    ...
    if 'is_vendor' in request.session:
        key_variable = request.session.pop('is_vendor')
